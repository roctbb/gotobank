...
В частности, Вы подозреваетесь в использовании гранатового финансирования в азартных играх. В соответствие со статьей 285.1 УК РФ, все выданные ранее средства возвращаются грантодателю, а ваше имущество (ноутбуки) конфискуется с целью продажи для покрытия неустойки.
